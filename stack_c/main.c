...
// Stack(Yýðýn) Lifo (last in first out) son giren ilk çýkar mantýðý vardýr. çamaþýrlar ile benzetilebilir.
// bellek yönetiminde sayfalarýn swap(takas) iþlemlerinde. uygulamalarýn geri al iþlemlerinde. tarayýcýlarýn geri al butonunda.
